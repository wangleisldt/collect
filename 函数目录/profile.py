...
proxies = None
# proxies = {
#     'http':'http://10.5.22.69:8118',
#     'https':'https://10.5.22.69:8118'
# }
...
# 一些表头
股票清单表头 = ['股票代码', '股票名称', '最新价', '涨跌幅', '涨跌额', '成交量(手)', '成交额', '振幅', '最高', '最低', '今开', '昨收', '量比', '换手率', '市盈率(动态)',
          '市净率', '总市值', '流通市值', '60日涨跌幅', '年初至今涨跌幅', '上市日期', '交易市场', '总股本', '流通股本', '所属行业', '地域板块', '所属板块', '可转债']
